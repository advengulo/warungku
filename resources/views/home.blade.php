        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h3>Rp {{ number_format($data['omset_today'],0,',','.') }}</h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3>Rp. {{ number_format($data['omset'],0,',','.') }}</h3>
                <p>Total Penjualan</p>
              </div>
              <div class="icon">
                <i class="ion ion-bag"></i>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-secondary">
              <div class="inner">
                <h3>Rp. {{ number_format($data['untung_today'],0,',','.') }}</h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
                <h3>Rp. {{ number_format($data['untung'],0,',','.') }}</h3>
